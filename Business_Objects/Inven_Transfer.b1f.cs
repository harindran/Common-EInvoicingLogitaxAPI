...
namespace EInvoicing_Logitax_API.Business_Objects
{
    ...
    class Inven_Transfer : SystemFormBase
    {
        ...
        private void Form_LoadAfter(SAPbouiCOM.SBOItemEventArg pVal)
        {
            ...
            strSQL = "SELECT \"SubID\" ,\"SubType\" FROM OEST o  ;";
            clsModule.objaddon.objglobalmethods.Load_Combo(oForm.UniqueID, ((SAPbouiCOM.ComboBox)oForm.Items.Item("ET0002").Specific), strSQL, new[] { "0,-" });

            strSQL = "SELECT  \"TypeCode\",\"TypeName\" FROM OEDT o;";
            clsModule.objaddon.objglobalmethods.Load_Combo(oForm.UniqueID, ((SAPbouiCOM.ComboBox)oForm.Items.Item("ET0003").Specific), strSQL, new[] { "0,-" });


            strSQL = "SELECT  \"ModeCode\" ,\"ModeName\"  FROM OETM o;";
            clsModule.objaddon.objglobalmethods.Load_Combo(oForm.UniqueID, ((SAPbouiCOM.ComboBox)oForm.Items.Item("ET00012").Specific), strSQL, new[] { "0,-" });
